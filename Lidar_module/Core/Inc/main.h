...
#define Ardu_LED1_Pin GPIO_PIN_8
#define Ardu_LED1_GPIO_Port GPIOD
#define Ardu_LED2_Pin GPIO_PIN_9
#define Ardu_LED2_GPIO_Port GPIOD
#define Ardu_LED3_Pin GPIO_PIN_11
#define Ardu_LED3_GPIO_Port GPIOD
