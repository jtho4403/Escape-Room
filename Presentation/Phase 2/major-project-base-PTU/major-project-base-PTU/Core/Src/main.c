...
volatile uint8_t end_string[64] = "Done!\r\n";
...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	...
	while (1){
		...
		return_value = HAL_I2C_Mem_Read(&hi2c1, magnet_rd, 0x03, 1, mag_data_buf, 6, 10);
		...
		if(x_angle < 30 && y_angle < 50 && z_angle < 10){
			while(1){
				setup_transmission(end_string, USART1_PORT);
			}
