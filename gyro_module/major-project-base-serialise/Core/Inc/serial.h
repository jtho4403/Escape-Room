...
void EnableSerialInterrupt(SerialPortserial_port);
...
void SerialOutputString(uint8_tpt, SerialPort serial_port);

void SerialInputSequence(SerialPortserial_port);
